...
import com.letshoppa.feechan.letshoppa.AdapterList.ReportItemAdapter;
import com.letshoppa.feechan.letshoppa.Class.Account;
import com.letshoppa.feechan.letshoppa.Class.AppHelper;
import com.letshoppa.feechan.letshoppa.Class.Report;
import com.letshoppa.feechan.letshoppa.Class.ReportLoadTask;
...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ReportItemAdapter(ReportActivity.this,listReports);
    ...
    {
        String url = AppHelper.domainURL + "/Downloads/PDFgenerator.php";
        if(AppHelper.currentAccount != null)
        {
            ...
            UpdateDataTask task = new UpdateDataTask(url,parameter,ReportActivity.this);
            task.execute();
        }
    }
    ...
    {
        String url = AppHelper.domainURL + "/AndroidConnect/GetReport.php";
        ReportLoadTask task = new ReportLoadTask(url,endDate,beginDate,mAdapter,ReportActivity.this);
        task.execute();
    }
